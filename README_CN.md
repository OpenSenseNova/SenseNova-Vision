...
- `[2026.07.08]` 首次发布 SenseNova-Vision [推理代码](./docs/INFERENCE.md)。
...
完整运行说明请参考 [`docs/INFERENCE.md`](./docs/INFERENCE.md)。
基准评测复现请参考 [`docs/EVAL.md`](./docs/EVAL.md)。
...
训练 SenseNova-Vision 时，请先按照
[`docs/train_data_prepare.md`](./docs/train_data_prepare.md) 准备训练数据，再按照
[`docs/TRAIN.md`](./docs/TRAIN.md) 启动训练。训练至少需要 2 台机器，每台配备
