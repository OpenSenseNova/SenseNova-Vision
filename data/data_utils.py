...
IMAGE_LOAD_ERROR_PREFIX = "Loading Image Error"
...
def load_image(image_path):
    """Load image from a local path and return a PIL Image object."""
    try:
        ...
        raise ImageLoadError(
            f"{IMAGE_LOAD_ERROR_PREFIX}: failed to load local image: {image_path}"
        ) from exc
