...
run_detection() {
  local datasets=(
    ...
    "${detection_jsonl_dir}/HumanRef.jsonl referring_object_detection 4988 1000 understanding"
    ...
    "${detection_jsonl_dir}/visual_prompt_eval/COCO.jsonl visual_prompt_detection 14632 5000 understanding"
