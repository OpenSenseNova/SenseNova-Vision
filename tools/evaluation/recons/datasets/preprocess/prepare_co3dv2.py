# Reference: https://github.com/facebookresearch/vggt/blob/evaluation/evaluation/preprocess_co3d.py
...
def get_parser():
    ...
    parser.add_argument("--output_dir", type=str, default="datas/co3dv2/annotations")
    parser.add_argument("--co3d_v2_dir", type=str, default="datas/co3dv2/data")
    parser.add_argument(
        "--min_quality",
        type=float,
        default=0.5,
